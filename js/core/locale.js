const localeDB = {
  ...
  addRepayment: { en: "Add Repayment", bn: "পরিশোধ যুক্ত করুন" },
  ...
  editRepayment: { en: "Edit repayment", bn: "পরিশোধ এডিট করুন" },
  editRepaymentTitle: { en: "Edit Repayment", bn: "পরিশোধ এডিট করুন" },
  deleteRepayment: { en: "Delete repayment", bn: "পরিশোধ মুছুন" },
